        ...
        <div className="page-wrap mt-34">
            <div className="flex flex-col md:flex-row justify-between gap-6">
                <div>
                    ...
                    <h1 className="text-4xl md:text-5xl text-text-primary font-extrabold max-w-xl mb-6 md:leading-16">
                    Let's build something
                    worth remembering.
                    </h1>
                    <p className="text-sm text-text-secondary md:w-130 leading-relaxed">
            ...
            <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <form action="" onSubmit={()=>null} className='flex flex-col gap-6'>
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className='flex flex-1 flex-col gap-1'>
                                ...
                                className='bg-surface-elevated border border-text-muted py-2 px-6 outline-0 focus:ring focus:ring-accent-hover
                                 h-10 rounded-xl text-sm text-text-primary font-bold placeholder:text-text-muted placeholder:font-bold' 
                        ...
                        <div className='flex flex-1 flex-col gap-1'>
                            ...
                            <div  className='
                                ...
                                h-10 rounded-xl text-sm text-text-primary font-bold'>
                        ...
                        <div className='flex flex-1 flex-col gap-1'>
                            ...
                            className='
                                ...
                                outline-0 focus:ring focus:ring-accent-hover
                                rounded-xl text-sm text-text-primary font-bold 
                                placeholder:text-text-muted placeholder:font-bold cursor-pointer'
                                placeholder="Hi Raphael, I'd love to discuss..."/>
                        </div>
                        <AnimatedButton 
                        classes='flex gap-2 items-center py-2.5 px-6 rounded-xl flex justify-center items-center w-[55%] md:w-[21%] cursor-pointer
                ...
                <hr className="block md:hidden text-text-muted w-full h-0.5 mt-18 mb-18" />
                <div className="flex flex-col gap-4 md:w-[30%]">
                    ...
                    <div className="bg-surface-elevated border border-text-muted rounded-xl p-3">
                        <div className="flex gap-4">
                            <div className="bg-accent-primary p-2 rounded-lg h-fit">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-text-muted text-[11px] w-[70%] leading-6 font-semibold">
